...
const disabledVariantClassnames = 'cursor-not-allowed opacity-70';
...
export function Button({
    ...
    const classNameWithVariant = classNames(
        ...
        className,
        {
            ...
            [disabledVariantClassnames]: disabled,
        },
    );
    ...
    return href ? (
        ...
        <button className={classNameWithVariant} type={buttonType} disabled={disabled}>
            {children}
        </button>
    );
}
