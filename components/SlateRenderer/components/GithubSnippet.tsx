...
const GithubSnippet: FunctionComponent<Props> = ({
    ...
    return (
        <div className={[styles.wrapper, themeClassName].join(' ')}>
            {isLoading && (
                <svg role="status" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-rose-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
